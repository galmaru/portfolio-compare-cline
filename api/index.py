...
from backend.services.stock_data import search_stocks, get_stock_price_data
...
def create_portfolio(portfolio: PortfolioCreate, db: Session = Depends(get_db)):
    from backend.models.database import Portfolio, PortfolioItem
...
def analyze_portfolio(portfolio, db) -> PortfolioComparisonResult:
    from backend.models.database import PortfolioItem
